	...
	<div class="container">
        ...
        <form method="post" class="form-data" id="form-data">  
        	<div class="row">
	            ...
	            <div class="col-sm-3">
	            	<div class="form-group">
						<label>tanggan pengerjaan</label><br>
						<input type="date" name="tgl_pengerjaan" id="tgl_pengerjaan" class="form-control" required="true">
						<p class="text-danger" id="err_tgl_pengerjaan"></p>
	            </div>
			</div>
			<div class="col-sm-6">
			<div class="form-group">
				<label>Pesanan</label>
				<textarea name="pesanan" id="pesanan" class="form-control" required="true"></textarea>
				<p class="text-danger" id="err_pesanan"></p>
			</div>
		</div>
		<div class="col-sm-3">
			<div class="form-group">
				<label>Total Biaya</label>
				<input type="text" name="total_biaya" id="total_biaya" class="form-control" required="true">
				<p class="text-danger" id="err_total_biaya"></p>
			</div>
		</div>

			<div class="col-sm-3">
			<div class="form-group">
				<button type="button" name="simpan" id="simpan" class="btn bg">
